...
const studentSchema = new mongoose.Schema(
  {
    ...
    // Stats tracking for badge system
    stats: {
      totalReportsSubmitted: { type: Number, default: 0 },
      reportsAtLevel3: { type: Number, default: 0 },
      instructorCommentsReceived: { type: Number, default: 0 },
      consecutiveGradedReports: { type: Number, default: 0 },
      highestSingleScore: { type: Number, default: 0 },
