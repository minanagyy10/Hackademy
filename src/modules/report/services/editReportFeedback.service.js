...
export const editReportFeedback = async (req, res) => {
  try {
    ...
    return res.status(200).json({ message: 'Report reviewed successfully', report: updatedReport });

  } catch (error) {
    console.log("Catch error from updateReportFeedback service", error);
